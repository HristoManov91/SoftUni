...
const homeSection = document.getElementById('movie-details');
homeSection.remove();
...
async function getMovie(id) {
    homeSection.replaceChildren(e('p', {}, 'Loading...'))
    ...
    if (userData != null) {
        request.push(fetch(`http://localhost:3030/data/likes?where=movieId%3D%22${id}%22%20and%20_ownerId%3D%22${userData._id}%22`))
    }
    ...
    homeSection.replaceChildren(createDetails(movieData, likes, hasLiked));
}
