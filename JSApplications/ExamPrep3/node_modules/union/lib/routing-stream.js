...
RoutingStream.prototype.route = function (req) {
  ...
  //
  // 1. Setup the pipe-chain between the `after` middlewares, the abstract response
  //    and the concrete response.
  // 2. Attempt to dispatch to the `before` middlewares, which represent things such as
