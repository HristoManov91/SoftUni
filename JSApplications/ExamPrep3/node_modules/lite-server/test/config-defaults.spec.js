...
describe('config-defaults', () => {
  ...
  it('should provide defaults', () => {
    fallbackMock.returns('fallback-middlewares');
    loggerMock.returns('logger-middlewares');
    ...
    assert.deepEqual(
      ...
      ['logger-middlewares', 'fallback-middlewares'],
      'includes middlewares'
    );
    assert.ok(loggerMock.called, 'logger middlewares initialized');
    assert.ok(fallbackMock.called, 'fallback middlewares initialized');
  });
});
