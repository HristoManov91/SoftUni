...
public class ControllerImpl implements Controller {
    ...
    public String buyComputer(int id) {
        ...
        Computer removeComp = computers.remove(id);

        return removeComp.toString();
    }

    @Override
    public String BuyBestComputer(double budget) {
        List<Computer> list = computers.values().stream().filter(c -> c.getPrice() <= budget)
